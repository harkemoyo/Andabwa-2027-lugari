<div class="mt-6">
    <div class="relative">
        ...
        <div class="relative flex justify-center text-sm uppercase">
            <span class="bg-gray-100 px-2 text-gray-500 font-medium tracking-wider">Or continue with</span>
        </div>
    </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($showDemo) && $showDemo): ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH C:\Users\Rygss\Downloads\andabwa-2027\resources\views/partials/social-auth-buttons.blade.php ENDPATH**/ ?>