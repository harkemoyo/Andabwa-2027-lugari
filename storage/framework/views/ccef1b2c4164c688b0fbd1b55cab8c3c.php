...
<div class="flex justify-center py-2 -mt-6">
    <a href="<?php echo e(route('blog.all-projects')); ?>"
        ...
        <div class="relative flex items-center gap-3">
            <span class="text-xs font-black uppercase tracking-[0.3em] text-white">Browse more projects</span>
...
</div><?php /**PATH C:\Users\Rygss\Downloads\andabwa-2027\resources\views/components/blog/browse-more-button.blade.php ENDPATH**/ ?>