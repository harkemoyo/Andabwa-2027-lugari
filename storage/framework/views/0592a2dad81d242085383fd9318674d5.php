<div class="max-w-7xl mx-auto px-6 py-12 font-semibold text-white">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="<?php echo e(route('services.show', 'web-development')); ?>" wire:navigate
        ...
        <a href="<?php echo e(route('services.show', 'mobile-apps')); ?>" wire:navigate
           class="p-6 bg-white rounded-xl shadow hover:shadow-lg transition">
            <h2 class="text-xl font-semibold mb-2">Mobile Apps</h2>
            <p class="text-gray-500 text-sm">iOS & Android apps built for performance.</p>
        </a>

        <a href="<?php echo e(route('services.show', 'ui-ux-design')); ?>" wire:navigate
           class="p-6 bg-white rounded-xl shadow hover:shadow-lg transition">
...
</div><?php /**PATH C:\Users\Rygss\Downloads\andabwa-2027\resources\views/livewire/pages/services-page.blade.php ENDPATH**/ ?>