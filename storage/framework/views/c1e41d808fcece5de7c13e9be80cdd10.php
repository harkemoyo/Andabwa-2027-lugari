...
<?php endif; ?>
            ...
            <div class="max-w-sm mx-auto text-center  grid grid-cols-1 md:grid-cols-2 ">
                ...
                <div class="justfy-self-center md:justify mt-2 ">
                    <a href="<?php echo e(route('home')); ?>" wire:navigate class="px-4 py-1 shadow-sm inline-flex   hover:underline items-center text-sm font-medium text-green-600  mb-6 transition-colors px-4 py-2 bg-slate-100 rounded-full">
                        <svg class="w-4 h-4 mr-2 animate-ping" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                        </svg>

                        <span class="text-[11px] font-bold tracking-widest uppercase text-slate-800 leading-tight">
                            <?php echo e($posts->pageSettings->editorial_button_text ?? 'Back to Editorial'); ?>
