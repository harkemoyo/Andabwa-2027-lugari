    ...
    public function run(): void
    {
        $widgets = [
            [
                ...
                'position' => 'right',
                'type' => 'ad',
                'content' => '<div data-ad-content data-src="<img src=\'imagess\andabwa-logo.svg\' class=\'w-full h-full object-cover\' />"></div>',
                'url' => 'https://google.com',
                'weight' => 1,
                'is_active' => true,
                'widget_image' => 'social-links/facebook.gif',
                'order' => 1,
            ],
            [
                ...
                'position' => 'right',
                'type' => 'ad',
                'content' => '<div data-ad-content data-src="<img src=\'imagess\smile.png\' class=\'w-full h-full object-cover\' />"></div>',
                'url' => 'https://google.com',
                'weight' => 2,
                'is_active' => true,
                'widget_image' => 'social-links/facebook.gif',
            ...
            [
                ...
                'position' => 'right',
                'type' => 'ad',
                'content' => '<div data-ad-content data-src="<img src=\'imagess\andabwa.png\' class=\'w-full h-full object-cover\' />"></div>',
                'url' => 'https://google.com',
                'weight' => 4,
                'is_active' => true,
                'widget_image' => 'social-links/facebook.gif',
            ...
            [
                ...
                'position' => 'right',
                'type' => 'ad',
                'content' => '<div data-ad-content data-src="<div class=\'bg-indigo-600 w-full h-full flex flex-col items-center justify-center text-white p-6\'><h2 class=\'text-2xl font-black italic\'>FLASH SALE</h2><p class=\'text-sm opacity-90\'>Limited Time Only</p><div data-ad-content data-src=\'<img src=&quot;imagess\andabwa-logo.svg&quot; class=&quot;w-full h-full object-cover&quot; />\'></div><button class=\'mt-4 bg-white text-indigo-600 px-4 py-2 rounded-full font-bold text-xs uppercase\'>Shop Now</button></div>"></div>',
                'url' => 'https://google.com',
                'weight' => 5,
                'is_active' => true,
                'widget_image' => 'social-links/facebook.gif',
            ...
            [
                ...
                'position' => 'right',
                'type' => 'ad',
                'content' => '<div data-ad-content data-src="<img src=\'imagess\walinzi-sacco.png\' class=\'w-full h-full object-cover\' />"></div>',
                'url' => 'https://google.com',
                'weight' => 7,
                'is_active' => true,
                'widget_image' => 'social-links/facebook.gif',
            ...
            [
                ...
                'position' => 'sidebar',
                'type' => 'ad',
                'content' => '<img src="/images/ads/premium-sponsor.jpg" alt="Sponsor" class="rounded w-full h-auto" />',
