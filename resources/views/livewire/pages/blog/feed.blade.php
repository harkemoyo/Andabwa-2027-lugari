<div class="min-h-screen bg-slate-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20">
        ...
        <div class="relative max-w-5xl mx-auto text-center pb-10">
            ...
            {{-- Emoji --}}
            <div class="text-2xl sm:text-3xl text-emerald-500 mt-3 mb-3 animate-pulse">
        ...
        {{-- SEARCH + FILTER BAR --}}
        <div
            class="bg-white p-3 rounded-xl shadow-sm flex flex-col md:flex-row items-center gap-4 max-w-4xl mx-auto mt-4">
            {{-- Search --}}
            <div class="relative w-full md:flex-1">
                <input wire:model.live.debounce.300ms="search" type="text" placeholder="Search..." class="w-full pr-12 pl-4 py-3 bg-white border rounded-lg text-sm text-slate-900 placeholder-slate-500
            ...
            {{-- Category --}}
            <select wire:model.live="categoryId" class="w-full md:w-56 py-3 px-4 bg-white border rounded-lg text-sm text-slate-800
                       focus:ring-2 focus:ring-emerald-500 focus:outline-none">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div
                class="relative group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 md:p-0">
