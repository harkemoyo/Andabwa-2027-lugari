...
<div class="relative w-full h-full overflow-hidden group">
    ...
    @elseif($isExternal && (!empty($data['embed_url']) || ($type === 'youtube' && !empty($post->external_url))))
        @php
    ...
    {{-- Article preview --}}
    @elseif($isExternal && ($type === 'article' || $type === 'external_link'))
        {{-- Article placeholder with title and description --}}
