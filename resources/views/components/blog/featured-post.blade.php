        ...
        <div class="-mt-4 sm:mt-16 md:-mt-16 lg:-mt-8 z-0">
            ...
            <section class="mb-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="group relative bg-white rounded-xl border border-1 hover:border-2 border-blue-300 hover:border-purple-500/40 transition-all duration-500 hover:-translate-y-1 overflow-hidden">
                        ...
                        <div class="relative grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="p-6 md:p-8 flex flex-col h-full">
                                ...
                                {{-- TITLE --}}
                                <h2 class="text-xl md:text-2xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-purple-600/40 transition">
                                    @php
                                ...
                                <div class="mt-auto pt-4 border-t border-gray-100">
                                    <a href="{{ $url }}"
                                        class="inline-flex items-center text-sm font-semibold text-green-600 hover:text-purple-500/40 transition">
