...
--}}
<article class="relative flex flex-col h-full bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all duration-300 hover:-translate-y-1 overflow-hidden group focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2">
    ...
    <div class="p-6 md:p-8 flex flex-col flex-1 relative">
        ...
        <div class="flex items-center justify-between gap-4 mb-4">
            ...
            <span class="relative z-20 inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 tracking-wide border border-indigo-100/50">
        ...
        <div class="mt-auto pt-4 border-t border-gray-100">
            <a href="{{ route('posts.show', $post->slug) }}" class="inline-flex items-center text-sm font-semibold text-indigo-600 group-hover:text-indigo-700 transition-colors whitespace-nowrap">
                Read Article
